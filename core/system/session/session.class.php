...
final class Session
{
    ...
    /**
     * Setup necessary session pre-start conditions.
     * @return void
     */
    ...
    {
    	return $this->isStarted() ? $this->isValid() : $this->setStarted(true);
    }
    ...
    public function destroy()
    {
    	...
    	if (isset($_COOKIE[session_name()]))
			setcookie(session_name(), '', time() - self::UNVALID_COOKIE_PERIOD, SLASH);
...
//    	$_SESSION['session_id'] = $_COOKIE[session_name()];
     ...
     */
    private function getLocalFingerprint()
    {
